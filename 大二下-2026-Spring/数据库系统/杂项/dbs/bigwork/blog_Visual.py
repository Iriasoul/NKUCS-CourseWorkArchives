...
pswd = urllib.parse.quote_plus('223561Aa@')

app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = f'mysql+pymysql://root:{pswd}@localhost:3306/blog'
app.config['SECRET_KEY'] = '223561Aa@'  # 设置你的秘密密钥
db = SQLAlchemy(app)
